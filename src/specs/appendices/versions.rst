...
.. list-table:: OSIA Interfaces Versions (Old Licence)
    :header-rows: 2
...
.. list-table:: OSIA Interfaces Versions (New Licence)
    :header-rows: 2
    :widths: 30 10 10
